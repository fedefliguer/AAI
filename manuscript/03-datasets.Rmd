...
Los datos se pusieron a disposición de Capital-Bikeshare.
...
Los datos se pueden descargar del [Depósito de aprendizaje automático de UCI](http://archive.ics.uci.edu/ml/datasets/Bike+Sharing+Dataset).
...
    - niebla + nubes, niebla + nubes rotas, niebla + pocas nubes, niebla
    - nieve ligera, lluvia ligera + tormenta eléctrica + nubes dispersas, lluvia ligera + nubes dispersas
    - fuertes lluvias + paletas de hielo + tormenta eléctrica + niebla, nieve + niebla
...
Puede encontrar el script R de procesamiento en el [repositorio de Github](https://github.com/christophM/interpretable-ml-book/blob/master/R/get-bike-sharing-dataset.R) junto con el [archivo RData final](https://github.com/christophM/interpretable-ml-book/blob/master/data/bike.RData).


<!--{pagebreak}-->

## Comentarios de spam de YouTube (clasificación de texto) {#spam-data}
Como ejemplo de clasificación de texto, trabajamos con 1956 comentarios de 5 videos de YouTube diferentes.
...
[Vea el video de ruptura de récords "Gangnam Style" aquí](https://www.youtube.com/watch?v=9bZkp7q19f0&feature=player_embedded).

Si deseas jugar con los datos, puedes encontrar el [archivo RData](https://github.com/christophM/interpretable-ml-book/blob/master/data/ycomments.RData) junto con [R -script](https://github.com/christophM/interpretable-ml-book/blob/master/R/get-SpamTube-dataset.R) con algunas funciones convenientes en el repositorio de Github del libro.
...
La biopsia sirve como estádndar para diagnosticar el cáncer cervical.
...
[preprocesamiento de script R](https://github.com/christophM/interpretable-ml-book/blob/master/R/get-cervical-cancer-dataset.R) y el
...
[^Fanaee]: Fanaee-T, Hadi y Joao Gama. "Etiquetado de eventos que combina detectores de conjunto y conocimientos básicos". Progreso en Inteligencia Artificial. Springer Berlin Heidelberg, 1–15. doi: 10.1007 / s13748-013-0040-3. (2013)

[^Alberto]: Alberto, Túlio C, Johannes V Lochter y Tiago A Almeida. "Tubespam: filtro de spam de comentarios en YouTube". En Machine Learning and Applications (Icmla), Ieee 14th International Conference on, 138–43. IEEE (2015)

[^Fernandes]: Fernandes, Kelwin, Jaime S Cardoso y Jessica Fernandes. "Transferir el aprendizaje con observabilidad parcial aplicada a la detección del cáncer cervical". Conferencia ibérica sobre reconocimiento de patrones y análisis de imágenes, 243–50. Saltador. (2017)
