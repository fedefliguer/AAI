...
`r if(is.html){"Podés comprar la versión en PDF y en e-book (epub, mobi) del libro [en leanpub.com](https://leanpub.com/interpretable-machine-learning)."}`

`r if(is.html){"Podés comprar la versión en papel [en lulu.com](http://www.lulu.com/shop/christoph-molnar/interpretable-machine-learning/paperback/product-24036234.html)."}`
